...
// Uses event delegation and re-queries frames on each interaction rather than
// caching them once, so it keeps working correctly even when the gallery
// re-renders (e.g. the photography page's location/date filters).
...
if (lightbox) {
  ...
  var currentFrames = function () { return Array.from(document.querySelectorAll('.frame')); };
  ...
  document.addEventListener('click', function (e) {
    ...
    if (!frame) return;
    var idx = currentFrames().indexOf(frame);
