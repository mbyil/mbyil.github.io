  ...
  articles: [
    {
      ...
      thumb: "https://picsum.photos/id/60/200/200",
    ...
    },
    {
      ...
      readTime: "8 MIN",
      category: "ENGINEERING",
      thumb: "https://picsum.photos/id/110/200/200",
    ...
    },
    {
      ...
      thumb: "https://picsum.photos/id/1039/200/200",
    ...
    },
    {
      ...
      readTime: "7 MIN",
      category: "ENGINEERING",
      thumb: "https://picsum.photos/id/127/200/200",
...
(function () {
  ...
  function articleRowHTML(a, index, basePath) {
    ...
    var thumbHtml = a.thumb
      ? '<div class="thumb"><img src="' + a.thumb + '" alt="' + (a.thumbAlt || '') + '" ' + loadAttrs(index, 2) + '></div>'
      : '';
    return (
  ...
  window.renderPhotoFilters = function (tabsId, galleryId) {
    ...
    function applyFilter(filter) {
      ...
      var items = allPhotos.filter(function (p) {
        return filter === 'Best of' ? !!p.best : p.country === filter;
      });
